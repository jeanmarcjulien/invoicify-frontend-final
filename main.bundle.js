...
var ContactComponent = (function () {
    function ContactComponent(dataService, dialog, sanitizer) {
        this.dataService = dataService;
        this.dialog = dialog;
    ...
    ContactComponent.prototype.onInput = function () {
        ...
        if (this.filterBy == 'fName') {
            this.contacts = this.originalContacts.filter(function (c) { return c.firstName.toLowerCase().includes(_this.searchText.toLowerCase()); });
        }
        else if (this.filterBy == 'lName') {
            this.contacts = this.originalContacts.filter(function (c) { return c.lastName.toLowerCase().includes(_this.searchText.toLowerCase()); });
        }
        else if (this.filterBy == 'email') {
            this.contacts = this.originalContacts.filter(function (c) { return c.email.toLowerCase().includes(_this.searchText.toLowerCase()); });
        }
        else if (this.filterBy == 'companyName') {
            this.contacts = this.originalContacts.filter(function (c) { return c.client.toLowerCase().includes(_this.searchText.toLowerCase()); });
        }
        else if (this.filterBy == 'phoneNumber') {
            this.contacts = this.originalContacts.filter(function (c) { return c.phoneNumber.toLowerCase().includes(_this.searchText.toLowerCase()); });
        }
        else if (this.filterBy == 'type') {
            this.contacts = this.originalContacts.filter(function (c) { return c.type.toLowerCase().includes(_this.searchText.toLowerCase()); });
        }
    };
...
module.exports = "<section @fadeInAnimation>\r\n  <div id=\"carousel-example-generic\" class=\"carousel slide\" data-ride=\"carousel\">\r\n    <!-- Indicators -->\r\n    <ol class=\"carousel-indicators\">\r\n      <li data-target=\"#carousel-example-generic\" data-slide-to=\"0\" class=\"active\"></li>\r\n      <li data-target=\"#carousel-example-generic\" data-slide-to=\"1\"></li>\r\n      <li data-target=\"#carousel-example-generic\" data-slide-to=\"2\"></li>\r\n    </ol>\r\n\r\n    <!-- Wrapper for slides -->\r\n    <div class=\"carousel-inner\" role=\"listbox\" height=\"300px\">\r\n      <div class=\"item active\">\r\n        <img src=\"http://i.imgur.com/M8NON2K.png\" height=\"300px\">\r\n        <div class=\"carousel-caption\">\r\n        </div>\r\n      </div>\r\n      <div class=\"item\">\r\n        <img src=\"http://imgur.com/i7NkWlr.png\" height=\"300px\">\r\n        <div class=\"carousel-caption\">\r\n          <h3></h3>\r\n          <p></p>\r\n        </div>\r\n      </div>\r\n      <div class=\"item\">\r\n        <img src=\"http://imgur.com/A6qSsUA.png\" height=\"300px\">\r\n        <div class=\"carousel-caption\">\r\n          <h3></h3>\r\n          <p></p>\r\n        </div>\r\n      </div>\r\n    </div>\r\n\r\n    <!-- Controls -->\r\n    <a class=\"left carousel-control\" href=\"#carousel-example-generic\" role=\"button\" data-slide=\"prev\">\r\n      <span class=\"glyphicon glyphicon-chevron-left\" aria-hidden=\"true\"></span>\r\n      <span class=\"sr-only\">Previous</span>\r\n    </a>\r\n    <a class=\"right carousel-control\" href=\"#carousel-example-generic\" role=\"button\" data-slide=\"next\">\r\n      <span class=\"glyphicon glyphicon-chevron-right\" aria-hidden=\"true\"></span>\r\n      <span class=\"sr-only\">Next</span>\r\n    </a>\r\n  </div>\r\n\r\n  <hr>\r\n  <div class=\"heading\">\r\n    <div class=\"heading1\">\r\n      <h2 class=\"heading\" align=\"center\">Welcome to Invoicify</h2>\r\n    </div>\r\n  </div>\r\n\r\n  <hr>\r\n\r\n  <div class=\"subheading\">\r\n    <div class=\"subheading1\">\r\n      <h2 class=\"title\">Invoice Management</h2>\r\n      <p class=\"heading\">Invoicify is a tool to help manage your company's finances. We provide a number of services to organize, keep track of, and sort through your records. Furthermore, Invoicify supports management for billing records, invoices, suppliers, and customer companies. With our NEW feature, we now also support the management of your business contacts! </p>\r\n    </div>\r\n  </div>\r\n\r\n</section>\r\n"
...
var routes = [
    ...
    { path: 'contact/edit/:id', component: __WEBPACK_IMPORTED_MODULE_13__contact_form_contact_form_component__["a" /* ContactFormComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_2__auth_guard_service__["a" /* AuthGuard */]] },
];
...
// module
exports.push([module.i, "div.filterStuff {\r\n    display: -ms-flexbox;\r\n    display: flex;\r\n    -ms-flex-pack: start;\r\n        justify-content: flex-start;\r\n    -ms-flex-direction: column;\r\n        flex-direction: column;\r\n    -ms-flex-align: end;\r\n        align-items: flex-end;\r\n  }\r\n  div.selectAndLabel {\r\n    -ms-flex-direction:row;\r\n        flex-direction:row;\r\n    margin-top: 10%;\r\n  }\r\n  div.topStuff {\r\n    display: -ms-flexbox;\r\n    display: flex;\r\n    -ms-flex-pack: justify;\r\n        justify-content: space-between;\r\n  }\r\n  h2 {\r\n    line-height: 0;\r\n    padding-bottom: 10px;\r\n  }\r\n  input#search{\r\n    width: 13.33em;\r\n  }", ""]);
